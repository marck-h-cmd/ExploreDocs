...
<div class="mb-10">
    ...
    <section class="relative bg-cover bg-center py-20 md:py-40" style="background-image: url('/images/fondo05.jpg');">
        ...
        <div class="relative z-10 flex flex-col justify-center items-center h-full px-6">
            <h1 class="text-[clamp(1.75rem,6vw,3.5rem)] md:text-[clamp(2.5rem,5vw,4rem)] font-bold text-white">
            ...
            <div class="w-full max-w-3xl">
                <form class="flex items-center bg-white rounded-lg overflow-hidden shadow-lg">
                    ...
                    <x-button
                        type="submit"
                        color="bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-3 flex items-center justify-center"
                        icon="bi bi-search" />
                </form>
    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto ">
            <h3 class="uppercase mb-10 font-bold text-center text-gray-800 text-2xl md:text-3xl tracking-wide">
                Autores más destacados
            </h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-4 justify-items-center items-stretch">
                <x-card-autor
                ...
                <x-card-autor
                    ...
                    description="Autor de 'El Señor de los Anillos' y 'El Hobbit'."
                    moreUrl="#" />
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto">
            <h3 class="uppercase mb-10 font-bold text-gray-800 text-2xl md:text-3xl text-center tracking-wide">Títulos Recientemente Subidos</h3>
            <div id="splide" class="splide mx-auto mb-8 text-center max-w-4xl">
                <div class="splide__track">
                    <ul class="splide__list">
                        <li class="splide__slide px-2"><img src="/images/libro01.jpeg" class="rounded shadow-lg w-36 mx-auto hover:scale-105 transition" alt="El Bosque Mágico"></li>
                        <li class="splide__slide px-2"><img src="/images/libro02.jpeg" class="rounded shadow-lg w-36 mx-auto hover:scale-105 transition" alt="Alicia en el País de las Maravillas"></li>
                        <li class="splide__slide px-2"><img src="/images/libro03.jpeg" class="rounded shadow-lg w-36 mx-auto hover:scale-105 transition" alt="Harry Potter y la piedra filosofal"></li>
                        <li class="splide__slide px-2"><img src="/images/libro04.jpeg" class="rounded shadow-lg w-36 mx-auto hover:scale-105 transition" alt="It (Eso)"></li>
                        <li class="splide__slide px-2"><img src="/images/libro05.webp" class="rounded shadow-lg w-36 mx-auto hover:scale-105 transition" alt="Libro 5"></li>
                        <li class="splide__slide px-2"><img src="/images/libro06.jpg" class="rounded shadow-lg w-36 mx-auto hover:scale-105 transition" alt="Libro 6"></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="bg-white py-16">
        <div class="max-w-5xl mx-auto">
            <h3 class="uppercase mb-10 font-bold text-gray-800 text-2xl md:text-3xl text-center tracking-wide">
                Conferencias
            </h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-4 items-stretch">
                <x-card-conference
            ...
            <div class="flex flex-col md:flex-row gap-10">
                <form class="flex-1 space-y-6 bg-white rounded-lg shadow p-8" id="for">
                    <div>
                        ...
                        <input type="text" class="w-full rounded border-gray-300 px-4 py-2 focus:ring-emerald-400" id="exampleFormControlInput2" placeholder="User Name">
                    </div>
                    <div>
                        <label for="exampleFormControlInput1" class="block font-semibold mb-2">Email</label>
                        <input type="email" class="w-full rounded border-gray-300 px-4 py-2 focus:ring-emerald-400" id="exampleFormControlInput1" placeholder="name@example.com">
                    </div>
                    <div>
                        <label for="exampleFormControlTextarea1" class="block font-semibold mb-2">Mensaje</label>
                        <textarea class="w-full rounded border-gray-300 px-4 py-2 focus:ring-emerald-400" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <button type="submit" class="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-2 rounded font-semibold transition">Enviar</button>
                </form>
                <div class="flex-1 flex items-center justify-center">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3286.410276127892!2d-79.04060262589138!3d-8.115327781204812!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91ad3d9fb3467261%3A0x752547ad9a204df6!2sUniversidad%20Nacional%20de%20Trujillo%20(UNT)!5e1!3m2!1ses-419!2spe!4v1734127574943!5m2!1ses-419!2spe"
                        width="100%" height="350" frameborder="0" style="border:0" allowfullscreen="" class="rounded-lg shadow"></iframe>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                <div class="flex items-center gap-5 bg-white rounded-lg shadow p-6">
                    <img src="https://www.wrappixel.com/demos/ui-kit/wrapkit/assets/images/contact/icon1.png" class="w-14 h-14">
                    <div>
                ...
                <div class="flex items-center gap-5 bg-white rounded-lg shadow p-6">
                    <img src="https://www.wrappixel.com/demos/ui-kit/wrapkit/assets/images/contact/icon2.png" class="w-14 h-14">
                    <div>
                ...
                <div class="flex items-center gap-5 bg-white rounded-lg shadow p-6">
                    <img src="https://www.wrappixel.com/demos/ui-kit/wrapkit/assets/images/contact/icon3.png" class="w-14 h-14">
                    <div>
